...
//        print("Updating order \(orderId) to status: \(status)")  // Log to check if this is being called
//
...
//                print("📡 STATUS UPDATE HTTP CODE:", http.statusCode)
//
//                // Debug server response
//                let serverReply = String(data: data, encoding: .utf8) ?? "<no text>"
